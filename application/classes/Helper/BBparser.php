...
'quote' => array(
                array( 'begin' => '<div class="quote">',
                        'end' => '</div>'), // if not attributes
                array( 'begin' => '<fieldset class="quote"><legend> Цитата %attr1% </legend>',
...
protected $simple_replace = array(
    ...
    '<a href="mailto:$1">$2</a>',
    '<a href="mailto:$1">$1</a>',
    '<img style="max-width:480px;max-height:400px;" src="$1" alt="" />',
    '<img style="max-width:480px;max-height:400px;" height="$2" width="$1" alt="" src="$3" />',
    '"<img " . str_replace("&#039;", "\"",str_replace("&quot;", "\"", "$1")) . " src=\"$2\" style=\"max-width:625px;max-height:400px;\" />"', //
    '<small>$1</small>',
    '<sub>$1</sub>',
    '<sup>$1</sup>',
    '<p>$1</p>',
    '<object width="480" height="360"><embed src="http://www.youtube.com/v/$1" type="application/x-shockwave-flash" width="480" height="360"></embed></object>',
