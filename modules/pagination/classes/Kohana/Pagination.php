...
class Kohana_Pagination {
	 ...
	 * @return  Pagination
	 */
	public static function factory(array $config = array(), Request $request = NULL, $tag = NULL)
	{
		return new Pagination($config, $request, $tag);
	}
	 ...
	 * @return  void
	 */
	public function __construct(array $config = array(), Request $request = NULL, $tag = NULL)
	{
