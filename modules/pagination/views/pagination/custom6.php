...
?>
	...
	<?php if ($first_page !== FALSE): ?>
		<a href="<?php echo 'questions/catid-'.$tag.'/page-'.$first_page.'.html'; ?>" rel="first"><?php echo __('Начало') ?></a>
	<?php else: ?>
		<div class="unactive"><?php echo __('Начало') ?></div>
	<?php endif ?>

	<?php if ($previous_page !== FALSE): ?>
		<a href="<?php echo 'questions/catid-'.$tag.'/page-'.$previous_page.'.html'; ?>" rel="prev"><?php echo __('Предыдущая страница') ?></a>
	<?php else: ?>
	...
	<?php foreach ($links as $number => $content): ?>
		...
		<?php else: ?>
			<a href="<?php echo 'questions/catid-'.$tag.'/page-'.$number.'.html'; ?>"><?php echo $content ?></a>
		<?php endif ?>

	<?php endforeach ?>

	<?php if ($next_page !== FALSE): ?>
		<a href="<?php echo 'questions/catid-'.$tag.'/page-'.$next_page.'.html'; ?>" rel="next"><?php echo __('Следующая страница') ?></a>
	<?php else: ?>
		<div class="unactive"><?php echo __('Следующая страница') ?></div>
	<?php endif ?>

	<?php if ($last_page !== FALSE): ?>
		<a href="<?php echo 'questions/catid-'.$tag.'/page-'.$last_page.'.html'; ?>" rel="last"><?php echo __('Конец') ?></a>
	<?php else: ?>
