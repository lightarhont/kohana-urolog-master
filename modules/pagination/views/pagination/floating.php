...
?>
	...
	<?php if ($first_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($first_page)) ?>" rel="first"><?php echo __('Начало') ?></a>
	<?php else: ?>
		<div class="unactive"><?php echo __('Начало') ?></div>
	<?php endif ?>

	<?php if ($previous_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($previous_page)) ?>" rel="prev"><?php echo __('Предыдущая страница') ?></a>
	<?php else: ?>
	...
	<?php if ($next_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($next_page)) ?>" rel="next"><?php echo __('Следующая страница') ?></a>
	<?php else: ?>
		<div class="unactive"><?php echo __('Следующая страница') ?></div>
	<?php endif ?>

	<?php if ($last_page !== FALSE): ?>
		<a href="<?php echo HTML::chars($page->url($last_page)) ?>" rel="last"><?php echo __('Конец') ?></a>
	<?php else: ?>
