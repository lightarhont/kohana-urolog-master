...
//			direction:			"ltr",
			...
			allButtons: {
				...
				video: {
					...
					transform: {
						'<iframe src="http://www.youtube.com/embed/{SRC}" width="480" height="360" frameborder="0"></iframe>':'[video]{SRC}[/video]'
					}
				},
			...
			smileList: [
				{title:CURLANG.sm1, img: '<img src="/public/images/wysibb/smiles/sm1.png" class="sm">', bbcode:":)"},
				{title:CURLANG.sm8 ,img: '<img src="/public/images/wysibb/smiles/sm8.png" class="sm">', bbcode:":("},
				{title:CURLANG.sm1, img: '<img src="/public/images/wysibb/smiles/sm2.png" class="sm">', bbcode:":D"},
				{title:CURLANG.sm3, img: '<img src="/public/images/wysibb/smiles/sm3.png" class="sm">', bbcode:";)"},
				{title:CURLANG.sm4, img: '<img src="/public/images/wysibb/smiles/sm4.png" class="sm">', bbcode:":up:"},
				{title:CURLANG.sm5, img: '<img src="/public/images/wysibb/smiles/sm5.png" class="sm">', bbcode:":down:"},
				{title:CURLANG.sm6, img: '<img src="/public/images/wysibb/smiles/sm6.png" class="sm">', bbcode:":shock:"},
				{title:CURLANG.sm7, img: '<img src="/public/images/wysibb/smiles/sm7.png" class="sm">', bbcode:":angry:"},
				{title:CURLANG.sm9, img: '<img src="/public/images/wysibb/smiles/sm9.png" class="sm">', bbcode:":sick:"}
			],
